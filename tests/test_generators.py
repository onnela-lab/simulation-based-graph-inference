...
@pytest.mark.parametrize(
    ...
    [
        ...
        (generators.duplication_complementation_graph, (0.7, 0.3)),
        (generators.duplication_complementation_graph, (0.5, 0.5, True)),
        (generators.duplication_mutation_graph, (0.6, 0.2)),
        (generators.duplication_mutation_graph, (0.5, 0.5, True)),
        (generators.redirection_graph, (4, 0.3)),
        (generators.web_graph, (0.5, 0.5, 0.5, np.arange(3) / 3)),
        (generators.jackson_rogers_graph, (4, 0.5, 3, 0.7)),
        (generators.surfer_graph, (0.1,)),
        (generators.random_connection_graph, (0.4,)),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (generators.duplication_complementation_graph, (-0.7, 0.3)),
        (generators.duplication_complementation_graph, (0.7, 1.1)),
        (generators.duplication_mutation_graph, (1.6, 0.2)),
        (generators.duplication_mutation_graph, (0.6, -0.2)),
        (generators.redirection_graph, (0, 0.3)),
