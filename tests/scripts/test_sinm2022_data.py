...
def test_sinm2022_data_dtype(tmpwd: str):
    sinm2022_data.__main__(dict2args(configuration="poisson_random_attachment", directory=".",
                                     num_batches=3, batch_size=2))
    with pytest.raises(ValueError):
        sinm2022_data.__main__(dict2args(
            configuration="poisson_random_attachment", directory=".", num_batches=2, batch_size=3,
